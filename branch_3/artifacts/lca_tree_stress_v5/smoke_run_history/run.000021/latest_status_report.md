...
- Run id: `run.000021`
- Run started at UTC: `2026-04-12T01:39:49Z`
- Run finished at UTC: `2026-04-12T01:41:59Z`
- Run elapsed seconds: `130`
- Public status: `PASS`
- Result family: `none`
- Failure partition: `pass`
- Normalized outcome: `pass`
- Normalized exit code: `0`
- Raw exit code: `0`
- Outcome source: `inner_wrapper`
- Required standard: `lca_tree_stress_v5`
- Summary: `inner smoke suite passed all cases`
...
- Run archive root: `/Users/free_1/Library/Mobile Documents/iCloud~md~obsidian/Documents/cpp-checker/branch_3/artifacts/lca_tree_stress_v5/smoke_run_history/run.000021`
- Run-archive source snapshot: `/Users/free_1/Library/Mobile Documents/iCloud~md~obsidian/Documents/cpp-checker/branch_3/artifacts/lca_tree_stress_v5/smoke_run_history/run.000021/source_root_snapshot`
- Run-archive source snapshot manifest: `/Users/free_1/Library/Mobile Documents/iCloud~md~obsidian/Documents/cpp-checker/branch_3/artifacts/lca_tree_stress_v5/smoke_run_history/run.000021/source_failure_snapshot_manifest.tsv`
- Run archive manifest: `/Users/free_1/Library/Mobile Documents/iCloud~md~obsidian/Documents/cpp-checker/branch_3/artifacts/lca_tree_stress_v5/smoke_run_history/run.000021/artifact_manifest.tsv`
- Launcher console transcript: `/Users/free_1/Library/Mobile Documents/iCloud~md~obsidian/Documents/cpp-checker/branch_3/artifacts/lca_tree_stress_v5/smoke_run_history/run.000021/console.stderr.txt`
- Dispatch result snapshot: `/Users/free_1/Library/Mobile Documents/iCloud~md~obsidian/Documents/cpp-checker/branch_3/artifacts/lca_tree_stress_v5/smoke_run_history/run.000021/dispatch_result.txt`
...
- Acceptance summary: `smoke accepted on this working tree; AC2 now has fresh same-worktree pass evidence for later gates`

## Iteration Support

- Iteration support: `ACTIONABLE`
- Next step: `gate_escalation`
- Iteration summary: `stable smoke status outputs are published; proceed to ./lca_strong_gate.sh on the same working tree`
- Control action: `escalate_to_strong_gate`
- Preferred next command: `./lca_strong_gate.sh`
- Command control mode: `gate_escalation`
- Preferred command kind: `gate`
- Failure terminal: `no`
- Gate escalation allowed: `yes`
- Next gate command: `./lca_strong_gate.sh`
- Next gate status: `ready_to_run`
- Next gate depends on: `AC2`
- Next gate summary: `smoke is green; run the required prerequisite gate next on the same working tree`

## Standard Gap

- Status: `ready_for_gate_escalation`
- Explanation: `smoke passed; this working tree has fresh smoke evidence and can escalate to heavier gates`

## Gate Chain

- AC2 (`./lca_smoke.sh`): status=`satisfied`; depends_on=`none`; summary=`fresh smoke evidence published for this working tree`
...
- AC4 (`./lca_strong_gate.sh && ./lca_strong_gate.sh`): status=`pending_after_ac3`; depends_on=`AC3`; summary=`strong-gate repeatability remains pending until AC3 records a fresh same-worktree pass`
...
- AC6 (`./lca_boj3s_gate.sh && ./lca_boj3s_gate.sh`): status=`blocked_by_ac5`; depends_on=`AC5`; summary=`boj3s repeatability remains blocked until AC5 records a fresh same-worktree pass`
...
- Summary: `changed public_status,result_family,normalized_outcome,stage_label relative to previous run run.000019`
...
- Previous run id: `run.000019`
- Previous run archive root: `/Users/free_1/Library/Mobile Documents/iCloud~md~obsidian/Documents/cpp-checker/branch_3/artifacts/lca_tree_stress_v5/smoke_run_history/run.000019`
...
- Previous status summary: `/Users/free_1/Library/Mobile Documents/iCloud~md~obsidian/Documents/cpp-checker/branch_3/artifacts/lca_tree_stress_v5/smoke_run_history/run.000019/summary.txt`
- Previous iteration evidence: `/Users/free_1/Library/Mobile Documents/iCloud~md~obsidian/Documents/cpp-checker/branch_3/artifacts/lca_tree_stress_v5/smoke_run_history/run.000019/iteration_evidence.txt`
