...
struct FinalCoreStepTrace {
    ...
    CanonicalExplicitGraph canonicalExplicitBefore;
    CanonicalExplicitGraph canonicalExplicitAfterNormalize;
    CanonicalExplicitGraph solverStepNextInputExplicit;
    bool hasSolverHandoffResyncDiagnostics = false;
    bool solverHandoffResyncApplied = false;
    std::string solverHandoffResyncWhy;
    RewriteTargetSnapshot solverStep2LiveTargetBeforeResync;
    RewriteTargetSnapshot solverStep2ShadowTarget;
    RewriteTargetSnapshot solverStep2LiveTargetAfterResync;
    bool hasSolverResyncBeforeTerminateDiagnostics = false;
    bool solverResyncBeforeTerminateApplied = false;
    std::string solverResyncBeforeTerminateReason;
    RewriteTargetSnapshot solverPostStepTargetSnapshotBeforeResync;
    RewriteTargetSnapshot solverShadowTargetSnapshot;
    RewriteTargetSnapshot solverPostStepTargetSnapshotAfterResync;
    bool terminated = false;
    std::string terminateReason;
};
...
struct StepTransitionSnapshot {
    ...
    bool solverHandoffResyncApplied = false;
    std::string solverHandoffResyncWhy;
    RewriteTargetSnapshot nextStepLiveTargetBeforeResync;
    RewriteTargetSnapshot nextStepShadowTarget;
    RewriteTargetSnapshot nextStepLiveTargetAfterResync;
};
