...
struct StrippedSelfLoopRemainder {
    CompactGraph Hrem;
    std::vector<int> remInputIdToFullInputId;
    std::vector<int> strippedLoopFullInputIds;
    VertexId loopVertex = -1;
};
...
enum class SequenceOneEdgeSubtype : uint8_t {
    SOE_REAL_NONLOOP,
    SOE_REAL_LOOP,
    SOE_PROXY_NONLOOP,
    SOE_PROXY_LOOP,
...
inline constexpr size_t kSequenceOneEdgeSubtypeCount =
    static_cast<size_t>(SequenceOneEdgeSubtype::COUNT);
...
enum class SelfLoopRemainderOtherNBSubtype : uint8_t {
    SLNB_DISCONNECTED,
    SLNB_STAR_AROUND_ONE_CUT,
    SLNB_COMPLEX_MULTI_CUT,
    SLNB_BLOCKS_ALL_TINY,
    SLNB_OTHER,
    COUNT
};
...
enum class XSharedLoopSharedInputSubtype : uint8_t {
    XLSI_REAL_LOOP_REAL_EDGE,
    XLSI_REAL_LOOP_PROXY_EDGE,
    XLSI_PROXY_LOOP_REAL_EDGE,
    XLSI_PROXY_LOOP_PROXY_EDGE,
    XLSI_OTHER,
    COUNT
};

inline constexpr size_t kXSharedLoopSharedInputSubtypeCount =
    static_cast<size_t>(XSharedLoopSharedInputSubtype::COUNT);

enum class XSharedLoopSharedBailout : uint8_t {
    XLSB_BUILDER_FAIL,
    XLSB_CHOOSE_KEEP_FAIL,
    XLSB_GRAFT_FAIL,
    XLSB_METADATA_REFRESH_FAIL,
    XLSB_POSTCHECK_ADJ_ONLY,
    XLSB_POSTCHECK_SAME_TYPE_SP_ONLY,
    XLSB_POSTCHECK_MIXED,
    XLSB_ORACLE_FAIL,
    XLSB_OTHER,
    COUNT
};

inline constexpr size_t kXSharedLoopSharedBailoutCount =
    static_cast<size_t>(XSharedLoopSharedBailout::COUNT);
...
enum class RewritePathTaken : uint8_t {
    ...
    SPECIAL_SELF_LOOP_SPQR_READY,
    SPECIAL_SELF_LOOP_ONE_EDGE,
    WHOLE_CORE_REBUILD,
    COUNT
};
...
enum class SequenceChooseStatus : uint8_t {
    FOUND,
    NONE,
    ERROR
};
...
struct RewriteRStats {
    ...
    std::array<uint64_t, kGraftPostcheckSubtypeCount> seqPostcheckSubtypeCounts{};
    std::array<uint64_t, kGraftPostcheckSubtypeCount> seqPostcheckCaseCountsBySubtype{};
    std::array<bool, kGraftPostcheckSubtypeCount> firstPostcheckSubtypeDumped{};
    std::array<std::string, kGraftPostcheckSubtypeCount> firstPostcheckSubtypeDumpPaths{};
    uint64_t seqDeferredSameTypeSPCount = 0;
    uint64_t seqDeferredSameTypeSPCaseCount = 0;
    std::array<uint64_t, kRewriteSeqTrackedSteps> seqDeferredSameTypeSPAtStepCounts{};
    bool firstDeferredSameTypeSPDumped = false;
    std::string firstDeferredSameTypeSPDumpPath;
    uint64_t seqSameTypeSPCleanupAttemptCount = 0;
    uint64_t seqSameTypeSPCleanupMergeCount = 0;
    uint64_t seqSameTypeSPCleanupSuccessCount = 0;
    uint64_t seqSameTypeSPCleanupFailCount = 0;
    uint64_t seqSameTypeSPCleanupCaseCount = 0;
    bool firstSameTypeSPCleanupDumped = false;
    std::string firstSameTypeSPCleanupDumpPath;
    ...
    uint64_t seqTooSmallOneEdgeHandledCount = 0;
    uint64_t seqTooSmallOneEdgeRealNonLoopHandledCount = 0;
    uint64_t seqTooSmallOneEdgeFallbackCount = 0;
    uint64_t seqLoopPlusEdgeSharedHandledCount = 0;
    uint64_t seqSelfLoopRemainderTwoPathHandledCount = 0;
    uint64_t seqSelfLoopRemainderSpqrReadyAttemptCount = 0;
    uint64_t seqSelfLoopRemainderSpqrReadyHandledCount = 0;
    uint64_t seqSelfLoopRemainderSpqrReadyFallbackCount = 0;
    uint64_t seqXIncidentSharedWithLoopHandledCount = 0;
    uint64_t seqXSharedLoopSharedProxyLoopRealAttemptCount = 0;
    uint64_t seqXSharedLoopSharedProxyLoopRealHandledCount = 0;
    uint64_t seqXSharedLoopSharedProxyLoopRealFallbackCount = 0;
    uint64_t seqXIncidentSpqrReadyAttemptCount = 0;
    uint64_t seqXIncidentSpqrReadyHandledCount = 0;
    uint64_t seqXIncidentSpqrReadyFallbackCount = 0;
    ...
    std::array<uint64_t, kSequenceOneEdgeSubtypeCount> seqTooSmallOneEdgeSubtypeCounts{};
    std::array<uint64_t, kSequenceOneEdgeSubtypeCount> seqTooSmallOneEdgeCaseCountsBySubtype{};
    std::array<bool, kSequenceOneEdgeSubtypeCount> firstTooSmallOneEdgeDumped{};
    std::array<std::string, kSequenceOneEdgeSubtypeCount> firstTooSmallOneEdgeDumpPaths{};
    ...
    std::array<uint64_t, kSelfLoopRemainderOtherNBSubtypeCount> seqSelfLoopOtherNBSubtypeCounts{};
    std::array<uint64_t, kSelfLoopRemainderOtherNBSubtypeCount>
        seqSelfLoopOtherNBCaseCountsBySubtype{};
    std::array<std::array<uint64_t, kSelfLoopRemainderOtherNBSubtypeCount>,
               kRewriteSeqTrackedSteps>
        seqSelfLoopOtherNBAtStepCounts{};
    std::array<bool, kSelfLoopRemainderOtherNBSubtypeCount> firstSelfLoopOtherNBDumped{};
    std::array<std::string, kSelfLoopRemainderOtherNBSubtypeCount>
        firstSelfLoopOtherNBDumpPaths{};
    bool firstSelfLoopRemainderSpqrReadyAttemptDumped = false;
    bool firstSelfLoopRemainderSpqrReadySuccessDumped = false;
    bool firstSelfLoopRemainderSpqrReadyFallbackDumped = false;
    std::string firstSelfLoopRemainderSpqrReadyAttemptDumpPath;
    std::string firstSelfLoopRemainderSpqrReadySuccessDumpPath;
    std::string firstSelfLoopRemainderSpqrReadyFallbackDumpPath;
    uint64_t seqSelfLoopRemainderOneEdgeAttemptCount = 0;
    uint64_t seqSelfLoopRemainderOneEdgeHandledCount = 0;
    uint64_t seqSelfLoopRemainderOneEdgeFallbackCount = 0;
    bool firstSelfLoopRemainderOneEdgeAttemptDumped = false;
    bool firstSelfLoopRemainderOneEdgeSuccessDumped = false;
    bool firstSelfLoopRemainderOneEdgeFallbackDumped = false;
    std::string firstSelfLoopRemainderOneEdgeAttemptDumpPath;
    std::string firstSelfLoopRemainderOneEdgeSuccessDumpPath;
    std::string firstSelfLoopRemainderOneEdgeFallbackDumpPath;
    ...
    std::array<uint64_t, kXSharedLoopSharedInputSubtypeCount>
        seqXSharedLoopSharedInputSubtypeCounts{};
    std::array<uint64_t, kXSharedLoopSharedInputSubtypeCount>
        seqXSharedLoopSharedCaseCountsByInputSubtype{};
    std::array<bool, kXSharedLoopSharedInputSubtypeCount>
        firstXSharedLoopSharedInputDumped{};
    std::array<std::string, kXSharedLoopSharedInputSubtypeCount>
        firstXSharedLoopSharedInputDumpPaths{};
    std::array<uint64_t, kXSharedLoopSharedBailoutCount>
        seqXSharedLoopSharedBailoutCounts{};
    std::array<std::array<uint64_t, kXSharedLoopSharedBailoutCount>, kRewriteSeqTrackedSteps>
        seqXSharedLoopSharedBailoutAtStepCounts{};
    std::array<bool, kXSharedLoopSharedBailoutCount>
        firstXSharedLoopSharedBailoutDumped{};
    std::array<std::string, kXSharedLoopSharedBailoutCount>
        firstXSharedLoopSharedBailoutDumpPaths{};
...
struct RewriteSeqStats {
    ...
    std::string failureWhere;
    std::string failureWhy;
    std::optional<NodeId> chosenR;
    std::optional<VertexId> chosenX;
    std::optional<ReducedSPQRCore> actualBeforeFailure;
    std::optional<ReducedSPQRCore> actualAfterFailure;
    std::optional<ExplicitBlockGraph> explicitBeforeFailure;
    std::optional<ExplicitBlockGraph> explicitAfterFailure;
