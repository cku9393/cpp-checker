...
static void dumpFinalCoreStepTrace(const FinalCoreStepTrace &trace, std::ostream &os) {
    ...
    os << "solverHandoffResyncApplied=" << (trace.solverHandoffResyncApplied ? 1 : 0)
       << "\n";
    os << "solverHandoffResyncWhy=" << trace.solverHandoffResyncWhy << "\n";
    os << "solverResyncBeforeTerminateApplied="
       << (trace.solverResyncBeforeTerminateApplied ? 1 : 0) << "\n";
    os << "solverResyncBeforeTerminateReason="
       << trace.solverResyncBeforeTerminateReason << "\n";
    ...
    os << "=== SolverStepNextInputExplicit ===\n";
    dumpCanonicalExplicitGraph(trace.solverStepNextInputExplicit, os);
    if (trace.hasSolverHandoffResyncDiagnostics) {
        dumpRewriteTargetSnapshot(trace.solverStep2LiveTargetBeforeResync,
                                  "SolverStep2LiveTargetBeforeResync",
                                  os);
        dumpRewriteTargetSnapshot(trace.solverStep2ShadowTarget,
                                  "SolverStep2ShadowTarget",
                                  os);
        dumpRewriteTargetSnapshot(trace.solverStep2LiveTargetAfterResync,
                                  "SolverStep2LiveTargetAfterResync",
                                  os);
    }
    if (trace.hasSolverResyncBeforeTerminateDiagnostics) {
        dumpRewriteTargetSnapshot(trace.solverPostStepTargetSnapshotBeforeResync,
                                  "SolverPostStepTargetSnapshotBeforeResync",
                                  os);
        dumpRewriteTargetSnapshot(trace.solverShadowTargetSnapshot,
                                  "SolverShadowTargetSnapshot",
                                  os);
        dumpRewriteTargetSnapshot(trace.solverPostStepTargetSnapshotAfterResync,
                                  "SolverPostStepTargetSnapshotAfterResync",
                                  os);
    }
}
...
static void dumpStepTransitionSnapshot(const StepTransitionSnapshot &snapshot,
    ...
    if (snapshot.hasSolverHandoffResyncDiagnostics) {
        os << "solverHandoffResyncApplied="
           << (snapshot.solverHandoffResyncApplied ? 1 : 0) << "\n";
        os << "solverHandoffResyncWhy=" << snapshot.solverHandoffResyncWhy << "\n";
        dumpRewriteTargetSnapshot(snapshot.nextStepLiveTargetBeforeResync,
                                  "NextStepLiveTargetBeforeResync",
                                  os);
        dumpRewriteTargetSnapshot(snapshot.nextStepShadowTarget,
                                  "NextStepShadowTarget",
                                  os);
        dumpRewriteTargetSnapshot(snapshot.nextStepLiveTargetAfterResync,
                                  "NextStepLiveTargetAfterResync",
                                  os);
    }
}
...
void dumpSolverFinalCoreReplayBundle(const SolverFinalCoreReplayBundle &bundle,
    ...
    ofs << "solverStats.solverResyncBeforeTerminateAttemptCount="
        << bundle.solverStats.solverResyncBeforeTerminateAttemptCount << "\n";
    ofs << "solverStats.solverResyncBeforeTerminateAppliedCount="
        << bundle.solverStats.solverResyncBeforeTerminateAppliedCount << "\n";
    ofs << "solverStats.solverResyncBeforeTerminateNoopCount="
        << bundle.solverStats.solverResyncBeforeTerminateNoopCount << "\n";
    ofs << "solverStats.solverResyncBeforeTerminateNoTargetToHasTargetCount="
        << bundle.solverStats.solverResyncBeforeTerminateNoTargetToHasTargetCount << "\n";
    ofs << "solverStats.solverResyncBeforeTerminateAliveRSetDifferCount="
        << bundle.solverStats.solverResyncBeforeTerminateAliveRSetDifferCount << "\n\n";
    ofs << "solverStats.solverHandoffResyncAttemptCount="
        << bundle.solverStats.solverHandoffResyncAttemptCount << "\n";
    ofs << "solverStats.solverHandoffResyncAppliedCount="
        << bundle.solverStats.solverHandoffResyncAppliedCount << "\n";
    ofs << "solverStats.solverHandoffResyncNoopCount="
        << bundle.solverStats.solverHandoffResyncNoopCount << "\n";
    ofs << "solverStats.solverHandoffResyncBuildFailCount="
        << bundle.solverStats.solverHandoffResyncBuildFailCount << "\n";
    ofs << "solverStats.solverHandoffResyncAliveRSetDifferCount="
        << bundle.solverStats.solverHandoffResyncAliveRSetDifferCount << "\n";
    ofs << "solverStats.solverHandoffResyncHasTargetDifferCount="
        << bundle.solverStats.solverHandoffResyncHasTargetDifferCount << "\n";
    ofs << "solverStats.solverHandoffResyncCandidateSetDifferCount="
