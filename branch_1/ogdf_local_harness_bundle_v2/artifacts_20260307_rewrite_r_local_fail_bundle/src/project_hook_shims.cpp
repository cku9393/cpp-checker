...
bool rewriteRFallback(harness::ReducedSPQRCore &,
                      ...
                      harness::VertexId,
                      std::string &why) {
    return failShim(why, "rewriteR_fallback",
                    "project::rewriteR_fallback(core, rNode, x, why)");
}

bool normalizeTouchedRegion(harness::ReducedSPQRCore &,
                            std::string &why) {
    return failShim(why, "normalizeTouchedRegion",
                    "project::normalizeTouchedRegion(core, why)");
}
