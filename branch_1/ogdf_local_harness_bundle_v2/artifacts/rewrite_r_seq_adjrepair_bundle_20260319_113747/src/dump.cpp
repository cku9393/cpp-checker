...
void dumpHarnessBundle(const HarnessBundle &B, const std::string &path) {
    ...
    ofs << "where=" << B.where << "\n";
    ofs << "why=" << B.why << "\n\n";
    if (B.stepIndex) ofs << "stepIndex=" << *B.stepIndex << "\n";
    if (B.sequenceLengthSoFar) ofs << "sequenceLengthSoFar=" << *B.sequenceLengthSoFar << "\n";
    if (B.chosenR) ofs << "chosenR=" << *B.chosenR << "\n";
    if (B.chosenX) ofs << "chosenX=" << *B.chosenX << "\n";
    if (B.stepIndex || B.sequenceLengthSoFar || B.chosenR || B.chosenX) ofs << "\n";
