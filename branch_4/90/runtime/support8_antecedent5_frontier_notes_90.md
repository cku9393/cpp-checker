# Support8 Antecedent5 Frontier Notes 90
...
- frontier tag: `support8_antecedent5_frontier`

current stats from current code path
- raw candidates: `224`
- canonical candidates: `154`
- outside-bounded candidates: `154`
...
- completed flag: `true`
- why: `authoritative support8 antecedent5 frontier theorem data imported from closed 70 output`

archival source
- preserved bundle note: missing for `support8_antecedent5_frontier_notes_90.md`
