# Antecedent Plus Three Frontier Notes 90
...
- frontier tag: `antecedent_plus_three_frontier`

current stats from current code path
- raw candidates: `112`
- canonical candidates: `70`
- outside-bounded candidates: `70`
...
- completed flag: `true`
- why: `authoritative antecedent plus three frontier theorem data imported from closed 71 output`

archival source
- preserved bundle note: missing for `antecedent_plus_three_frontier_notes_90.md`
