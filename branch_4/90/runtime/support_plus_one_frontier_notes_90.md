# Support Plus One Frontier Notes 90
...
- frontier tag: `support_plus_one_frontier`

current stats from current code path
- raw candidates: `368`
- canonical candidates: `294`
- outside-bounded candidates: `294`
- local exact survivors: `161`
- plus-one survivors: `6`
- theorem-preserving survivors: `0`
- unsupported local exact candidates: `0`
- unsupported plus-one candidates: `0`
- completed flag: `true`
- why: `authoritative support-plus-one frontier theorem data imported from 67 output`

archival source
- preserved bundle note: missing for `support_plus_one_frontier_notes_90.md`
