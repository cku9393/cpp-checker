# Antecedent Plus Four Frontier Notes 90
...
- frontier tag: `antecedent_plus_four_frontier`
...
- completed flag: `true`
- why: `authoritative antecedent plus four frontier theorem data imported from closed 72 output`

archival source
- preserved bundle note: missing for `antecedent_plus_four_frontier_notes_90.md`
