# Antecedent Plus One Frontier Notes 90
...
- frontier tag: `antecedent_plus_one_frontier`

current stats from current code path
- raw candidates: `648`
- canonical candidates: `502`
- outside-bounded candidates: `208`
...
- completed flag: `true`
- why: `authoritative antecedent-plus-one frontier theorem data imported from 67 output`

archival source
- preserved bundle note: missing for `antecedent_plus_one_frontier_notes_90.md`
