# Antecedent Plus Two Frontier Notes 90
...
- frontier tag: `antecedent_plus_two_frontier`
...
- completed flag: `true`
- why: `authoritative antecedent plus two frontier theorem data imported from closed 70 output`

archival source
- preserved bundle note: missing for `antecedent_plus_two_frontier_notes_90.md`
