# Support8 Antecedent7 Frontier Notes 90
...
- frontier tag: `support8_antecedent7_frontier`

current stats from current code path
- raw candidates: `32`
- canonical candidates: `18`
- outside-bounded candidates: `18`
...
- completed flag: `true`
- why: `authoritative support8 antecedent7 frontier theorem data imported from closed 72 output`

archival source
- preserved bundle note: missing for `support8_antecedent7_frontier_notes_90.md`
