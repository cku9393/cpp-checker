...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Portable build wrapper for lca_tree_stress_v5_tooling_solver.cpp."
    )
    ap.add_argument("--compiler", default=None, help="compiler executable to use")
    ap.add_argument("--source", default="lca_tree_stress_v5_tooling_solver.cpp")
    ...
    print("[build] failed to compile lca_tree_stress_v5_tooling_solver.cpp", file=sys.stderr)
    if tried:
