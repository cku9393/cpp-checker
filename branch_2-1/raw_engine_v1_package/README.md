...
- For light-bundle review, start with `bundle_metadata.json`, then `policy_ops_summary_<phase>.json`, then `runtime_current_env_guardrail_*.json`, `runtime_current_env_age_tick_*.json`, `runtime_current_env_watch_plan_*.json`, `runtime_current_env_reproposal_trigger_gate_*.json`, `runtime_current_env_watch_history_*.json`, and `runtime_budget_registry_*_summary.json`. Only open the curated/full bundle when you need raw repeated-watch campaign logs or archived budget reproposals.
