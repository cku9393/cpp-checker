...
struct TestOptions {
    ...
    std::optional<std::string> sourceManifest;
    std::optional<std::string> baselineManifest;
    std::optional<std::string> baselineOut;
    std::optional<std::string> baselineTag;
    std::optional<std::string> currentManifest;
    std::optional<std::string> refreshManifest;
    std::optional<std::string> gateFamily;
    std::optional<std::string> gateOutput;
    std::optional<std::string> rerunPlan;
    std::optional<std::string> runtimeBaselineManifest;
    std::optional<std::string> runtimeBaselineRegistry;
    std::optional<std::string> runtimeCurrentManifest;
    std::optional<std::string> runtimeRefreshManifest;
    std::optional<std::string> runtimeRerunPlan;
    std::optional<std::string> runtimeHistoryIndex;
    std::optional<std::string> runtimeWatchCurrent;
    ...
    std::optional<std::string> retireBaseline;
    std::optional<std::string> syntheticHashDrift;
    std::optional<std::string> syntheticApplicabilityDrift;
    std::optional<std::string> syntheticDiagnosticPromotion;
    std::vector<std::string> revalidateFamilies;
    std::vector<std::string> familyFilter;
    std::vector<std::string> runtimeStageSpecs;
    std::vector<std::string> runtimeTestCountSpecs;
    bool gateStrict = false;
    bool freshnessOnly = false;
    bool markStaleOnHashChange = true;
    bool allowStale = false;
    bool strictRefresh = false;
