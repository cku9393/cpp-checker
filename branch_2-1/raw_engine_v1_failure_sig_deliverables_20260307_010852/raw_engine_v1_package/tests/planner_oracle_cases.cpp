...
void execute_planner_capture(
    ...
    run_actual_planner_impl(RE, ctx, U, runOptions, initialQueue, trace, activePhase);
}
...
void run_planner_checked(
    ...
    vector<PlannerTraceEntry> trace;
    execute_planner_capture(RE, ctx, U, runOptions, nullptr, trace, nullptr);
    g_lastPlannerTrace = trace;
