...
void print_usage(ostream& os) {
    ...
    os << "  --stats\n";
    os << "  --stats-file <path>\n";
    os << "  --fuzz-mode random|weighted_split_heavy|weighted_join_heavy|weighted_integrate_heavy|artifact_heavy|multiedge_heavy\n";
    ...
    try {
        ...
        for (int i = 1; i < argc; ++i) {
            ...
            if (arg == "--case") {
                ...
                options.stats = true;
            } else if (arg == "--fuzz-mode" || arg == "--weight-profile") {
