...
PlannerOracleComparison compare_planner_oracle(
    ...
    comparison.expected = run_reference_planner(before, ctx, runOptions, !actualTrace.empty()).signature;
...
bool check_planner_oracle(
    ...
    const PlannerOracleComparison comparison = compare_planner_oracle(before, after, ctx, runOptions, actualTrace);
